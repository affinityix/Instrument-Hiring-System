...
namespace InstrumentHiringSystem.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult CancelOrder(OrderViewModel orderViewModel)
        {
            ...
            if (orderHeader.PaymentStatus == Constant.Payment_Approved)
            {
                ...
                _unitOfWork.OrderHeader.UpdateStatus(orderHeader.ID, Constant.Status_Cancelled, Constant.Status_Refunded);
            }
            else
            {
                _unitOfWork.OrderHeader.UpdateStatus(orderHeader.ID, Constant.Status_Cancelled, Constant.Status_Cancelled);
            }
